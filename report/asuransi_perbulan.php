            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA ASURANSI BULAN   <?php echo "$bulanNama $ambilthn"; ?></h3>
                        <table class="table table-bordered table-striped table-hover">
                        <tbody>
                <thead>
								<tr>
                    <th>No.</th><th width="18%">No. Asuransi</th><th width="14%">Nama</th><th width="15%">Alamat</th><th>Nomor kendaraan</th><th>No. Ktp</th>
                </tr>
								</thead>
							<tbody>
                            ...
                            $sql = "SELECT * FROM asuransi WHERE substr(tgl_buat,1,7)='$ambilthn/$ambilbln'";

            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA kecelakaan BULAN   <?php echo "$bulanNama $ambilthn"; ?></h3>
                        <table class="table table-bordered table-striped table-hover">
                        <tbody>
                <thead>
								<tr>
                  <th>No.</th><th>No. Asuransi</th><th>Tempat</th><th>Tanggal kecelakaan</th><th>korban</th>
                </tr>
								</thead>
							<tbody>
                            ...
                            $sql = "SELECT * FROM kecelakaan WHERE substr(tgl_kecelakaan,1,7)='$ambilthn-$ambilbln'";
